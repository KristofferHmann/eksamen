...
export default class Database {
  ...
  // Asynkron metode til at redigere måltider
  async editMeals(mealID, mealData) {
    try {
      ...
      // Opretter en ny forespørgsel ved hjælp af poolforbindelsen
      const request = this.poolconnection.request();
      // Uddrager måltidsdata fra det givne dataobjekt
      ...
      // Udfører SQL-forespørgslen til at opdatere et måltid
      const result = await request.query(`
        UPDATE Nutri.Meals
        SET 
            weight = @weight,
      ...
      // Logger fejl, hvis der opstår en under redigering af måltidet
      console.error('Fejl ved redigering af måltid:', error.message);
      throw error;
    }
  }

  // Asynkron metode til at oprette måltidsingredienser
  async createMealIngredients(ingredientData, meal_ID) {
    ...
    // Udfører SQL-forespørgslen til at indsætte en ny måltidsingrediens
  ...
  // Asynkron metode til at hente en brugers måltider
  async getUserMeals(userID) {
    ...
    // Definerer inputparametrene til forespørgslen
    request.input('user_ID', sql.Int, userID)
    // Udfører SQL-forespørgslen til at hente en brugers måltider
    const result = await request.query(
  ...
  // Asynkron metode til at hente alle aktiviteter
  async getAllActivities() {
    ...
    // Udfører SQL-forespørgslen til at hente alle aktiviteter
  ...
  // Asynkron metode til at hente en brugers aktiviteter
  async getUserActivities(userID) {
    ...
    // Udfører SQL-forespørgslen til at hente en brugers aktiviteter
  ...
  // Asynkron metode til at tilføje en aktivitet
  async addActivity(data, userID) {
    ...
    // Udfører SQL-forespørgslen til at tilføje en ny aktivitet
  ...
  // Asynkron metode til at hente en ingrediens
  async getIngredient(data) {
    ...
    // Udfører SQL-forespørgslen til at hente en ingrediens
  ...
  // Asynkron metode til at hente en brugers vandindtag
  async getUserWater(userID) {
    ...
    // Udfører SQL-forespørgslen til at hente en brugers vandindtag
